...
public class Vehicle : Component
{
    ...
    public virtual float Angle
    {
        get
        {
            GetComponent<NativeVehicle>()
                .GetVehicleZAngle(out var angle);
            return angle;
        }
        set => GetComponent<NativeVehicle>()
            .SetVehicleZAngle(value);
    }
    ...
    public virtual EntityId Trailer
    {
        ...
        set
        {
            if (!value)
                ...
                Manager.GetComponent<NativeVehicle>(value)
                    .AttachTrailerToVehicle(Entity);
        }
    }
    ...
    public virtual Vector3 Velocity
    {
        ...
        {
            GetComponent<NativeVehicle>()
                .GetVehicleVelocity(out var x, out var y, out var z);
            return new Vector3(x, y, z);
        }
        set => GetComponent<NativeVehicle>()
            .SetVehicleVelocity(value.X, value.Y, value.Z);
    }
    ...
    public virtual bool Engine
    {
        ...
        set
        {
            ...
            SetParameters(value
                ? VehicleParameterValue.On
                : VehicleParameterValue.Off, b, c, d, e, f, g);
        }
    }
    ...
    public virtual bool Lights
    {
        ...
        set
        {
            ...
            SetParameters(a, value
                ? VehicleParameterValue.On
                : VehicleParameterValue.Off, c, d, e, f, g);
        }
    }
    ...
    public virtual bool Alarm
    {
        ...
        set
        {
            ...
            SetParameters(a, b, value
                ? VehicleParameterValue.On
                : VehicleParameterValue.Off, d, e, f, g);
        }
    }
    ...
    public virtual bool Doors
    {
        ...
        set
        {
            ...
            SetParameters(a, b, c, value
                ? VehicleParameterValue.On
                : VehicleParameterValue.Off, e, f, g);
        }
    }
    ...
    public virtual bool Bonnet
    {
        ...
        set
        {
            ...
            SetParameters(a, b, c, d, value
                ? VehicleParameterValue.On
                : VehicleParameterValue.Off, f, g);
        }
    }
    ...
    public virtual bool Boot
    {
        ...
        set
        {
            ...
            SetParameters(a, b, c, d, e, value
                ? VehicleParameterValue.On
                : VehicleParameterValue.Off, g);
        }
    }
    ...
    public virtual bool IsDriverDoorOpen
    {
        ...
        set
        {
            ...
            SetDoorsParameters(value
                ? VehicleParameterValue.On
                : VehicleParameterValue.Off, b, c, d);
        }
    }
    ...
    public virtual bool IsPassengerDoorOpen
    {
        ...
        set
        {
            ...
            SetDoorsParameters(a, value
                ? VehicleParameterValue.On
                : VehicleParameterValue.Off, c, d);
        }
    }
    ...
    public virtual bool IsBackLeftDoorOpen
    {
        ...
        set
        {
            ...
            SetDoorsParameters(a, b, value
                ? VehicleParameterValue.On
                : VehicleParameterValue.Off, d);
        }
    }
    ...
    public virtual bool IsBackLeftWindowClosed
    {
        ...
        set
        {
            ...
            SetWindowsParameters(a, b, value
                ? VehicleParameterValue.On
                : VehicleParameterValue.Off, d);
        }
    }
    ...
    public virtual float Health
    {
        ...
        {
            GetComponent<NativeVehicle>()
                .GetVehicleHealth(out var value);
            return value;
        }
        set => GetComponent<NativeVehicle>()
    ...
    public virtual Vector3 Position
    {
        ...
        {
            GetComponent<NativeVehicle>()
                .GetVehiclePos(out var x, out var y, out var z);
            return new Vector3(x, y, z);
        }
        set => GetComponent<NativeVehicle>()
            .SetVehiclePos(value.X, value.Y, value.Z);
    }
    ...
    public virtual void SetParametersForPlayer(EntityId player, bool objective, bool doorsLocked)
    {
        ...
        GetComponent<NativeVehicle>()
            .SetVehicleParamsForPlayer(player, objective, doorsLocked);
    }

    /// <summary>Sets this vehicle's parameters for all players.</summary>
    ...
    {
        GetComponent<NativeVehicle>()
            .SetVehicleParamsEx((int)engine, (int)lights, (int)alarm, (int)doors, (int)bonnet, (int)boot, (int)objective);
    }

    /// <summary>Gets this vehicle's parameters.</summary>
    ...
    {
        GetComponent<NativeVehicle>()
            .GetVehicleParamsEx(out var tmpEngine, out var tmpLights, out var tmpAlarm, out var tmpDoors, out var tmpBonnet, out var tmpBoot,
                out var tmpObjective);
    ...
    {
        return value == VehicleParameterValue.Unset
            ? defaultValue
            : value == VehicleParameterValue.On;
    }

    /// <summary>Sets the doors parameters.</summary>
    ...
    /// <summary>Gets the doors parameters.</summary>
    /// <param name="driver">if on the driver side door is open.</param>
    /// <param name="passenger">if on the passenger side door is open.</param>
    /// <param name="backLeft">if on the back-left door is open.</param>
    /// <param name="backRight">if on the back-right door is open.</param>
    ...
    {
        GetComponent<NativeVehicle>()
            .GetVehicleParamsCarDoors(out var tmpDriver, out var tmpPassenger, out var tmpBackLeft, out var tmpBackRight);
    ...
    /// <summary>Sets the windows parameters.</summary>
